        ...
        do {
            ...
            if (!this.playerA.gameEnd() && !this.playerB.gameEnd()) {
                ...
                if (this.wPressed) {
                    ...
                    if (this.tankA.healthPackCollision(this.walls, this.playerA)) {
                    ...
                    if (this.tankA.landMineCollision(this.walls)) {
                        this.playerA.landMine();
                    }
                ...
                if (this.iPressed) {
                    ...
                    //if tank is colliding with power up (health pack/landmine)
                    if (this.tankB.healthPackCollision(this.walls, this.playerB)) {
                    ...
                    if (this.tankB.landMineCollision(this.walls)) {
                        this.playerB.landMine();
                    }
