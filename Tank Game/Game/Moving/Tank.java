...
public class Tank extends ImageObject {
     ...
     * @return colliding
     */
    public boolean healthPackCollision(Walls wall, Player player) {
    ...
    /**
     * determines if colliding with landmine
     *
     * @param wall layout
     * @return colliding
     */
    public boolean landMineCollision(Walls wall) {
        ...
        for (int row = 0; row < wall.getMapHeight(); row++) {
            ...
            for (int col = 0; col < wall.getMapWidth(); col++) {
                ...
                if (wall.getWallLayout()[row][col].equals("6")) {
